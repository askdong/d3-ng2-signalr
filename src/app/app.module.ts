...
import { WrapperWaferMapComponent } from './d3-demos/wrapper-wafer-map/wrapper-wafer-map.component';
import { WaferMapComponent } from './d3-demos/wafer-map/wafer-map.component';

export function createConfig(): SignalRConfiguration {
  const c = new SignalRConfiguration();
  c.hubName = 'ChatHub';
  c.qs = { user: 'donald' };
  c.url = 'http://localhost:52527/';
  c.logging = false;
  return c;
}
